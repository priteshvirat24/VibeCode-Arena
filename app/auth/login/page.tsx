...
export default function LoginPage() {
  return (
    <div className="max-w-md mx-auto mt-16 p-6 bg-slate-800 rounded-xl">
      <h2 className="text-2xl font-bold mb-6 text-center">Log In to Arena</h2>
      <div className="space-y-4">
        ...
        <div className="text-center text-sm text-slate-400 mt-6">
          New here? <Link href="/auth/signup" className="text-emerald-400 hover:text-emerald-300">Create an account</Link>
        </div>
      </div>
    </div>
  );
